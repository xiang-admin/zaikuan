...
public class PoiUtils {
    ...
    public static <T> List<T> importExcel(MultipartFile file, Integer titleRows, Integer headerRows, Class pojoClass) throws NormalException {
        if (file == null) {
            return null;
        }
        ImportParams params = new ImportParams();
    ...
    public static void main(String args[]) throws NormalException {
